...
function getTime()
{
	...
	document.forms['clockOutPage'].time.value = curr_hour+"."+curr_min;
...
function getDate(){
	...
	var date= d.getDate();
	document.forms['clockOutPage'].date.value = year+"-"+date+"-"+month;	
...
<body>
<form name="clockOutPage" action="submitClockOutRecord.jsp">
